 ...
 *
 * 视频：81丨prototype Bean作用域：原型Bean在哪些场景下会创建新的实例？.mp4
 * ppt: 第八章 Spring Bean作用域（Scopes）.pdf
 *
 * @author <quanzhang875@gmail.com>
 * @since  2023-10-01 19:51:48
 */
public class BeanScopeDemo implements DisposableBean {

	@Bean
	@Scope(ConfigurableBeanFactory.SCOPE_SINGLETON) // 默认 scope 就是 "singleton"
	...
	public static void main(String[] args) {
		...
		// 不过仅 Singleton Bean 会执行销毁方法回调，如果要销毁 Prototype Bean 要 implements DisposableBean
	...
	public void destroy() throws Exception {
		...
		// 获取 BeanDefinition，销毁集合 Bean中的 prototype Bean
